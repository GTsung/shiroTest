...
import com.home.utils.JdbcTemplateUtils;
...
public abstract class BaseTest {
    ...
    @Before
    public void setUp() {
        JdbcTemplateUtils.getJdbc().update("delete from sys_users");
        JdbcTemplateUtils.getJdbc().update("delete from sys_roles");
        JdbcTemplateUtils.getJdbc().update("delete from sys_permissions");
        JdbcTemplateUtils.getJdbc().update("delete from sys_users_roles");
        JdbcTemplateUtils.getJdbc().update("delete from sys_roles_permissions");
